  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary-light hover:scale-105 active:scale-95",
        ...
        hero: "bg-gradient-hero text-primary-foreground shadow-glow hover:shadow-strong hover:scale-110 active:scale-95 text-base font-semibold",
        ...
        destructive: "bg-error text-error-foreground hover:bg-error/90 hover:scale-105 active:scale-95",
      },
      size: {
